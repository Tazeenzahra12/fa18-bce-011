    ...
    return (
       <>
        <div className="PreFooter">
            <div>
                {repeatIcon}
                 <p> <b>Hassle-free replacement</b> <br/>10-day easy replacement policy on Bagerz.com</p>
               </div>
            <div>{shieldIcon} <p> <b>100% secure payments</b> <br/> We support Cards, Wallets and COD</p></div>
            <div>{mapIcon} <p> <b>Vast service network</b> <br/> Service-centers across cities</p></div>
        </div>
       ...
       <div> Copyright © 2010 - 2021 Bagerz. All Rights Reserved</div>
        </div>
